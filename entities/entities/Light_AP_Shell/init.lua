...
------------------------
Light_AP_Shell init.lua
	-Light AP Tank Round Entity serverside init
*/
...
function ENT:Initialize()
	...
	util.SpriteTrail(self.Entity, 0, Color(255,175,175,50), false, 4, 1, 2, 1/(15+1)*0.5, "trails/smoke.vmt")
end
