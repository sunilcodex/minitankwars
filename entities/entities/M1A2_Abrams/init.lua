...
function ENT:Initialize()
	...
	self.Entity:SetModel( "models/BMCha/MiniTanks/M1A2_Abrams/M1A2_Abrams_Body.mdl") //ProtoTank/ProtoTank_   T-90/T-90_ M1A2_Abrams_
	self.Entity:PhysicsInit( SOLID_VPHYSICS )
	self.Entity:SetMoveType( MOVETYPE_VPHYSICS )
	self.Entity:SetSolid( SOLID_VPHYSICS )
	
	self.TurretEnt= ents.Create( "M1A2_Abrams_Turret" )
	...
	self.TracksEnt= ents.Create( "M1A2_Abrams_Tracks" )
