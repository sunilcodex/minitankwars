...
function ENT:Initialize()
	...
	self.Entity:SetModel( "models/BMCha/MiniTanks/M551_Sheridan/M551_Sheridan_Body.mdl") //ProtoTank/ProtoTank_   T-90/T-90_ M1A2_Abrams_
	self.Entity:PhysicsInit( SOLID_VPHYSICS )
	self.Entity:SetMoveType( MOVETYPE_VPHYSICS )
	self.Entity:SetSolid( SOLID_VPHYSICS )
	
	self.TurretEnt= ents.Create( "M551_Sheridan_Turret" )
	...
	self.TracksEnt= ents.Create( "M551_Sheridan_Tracks" )
